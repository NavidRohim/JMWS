...
public class JMWSPlugin implements IClientPlugin {
    ...
    public void initialize(@NotNull IClientAPI jmClientApi)
    {
        ...
        CommonEventRegistry.WAYPOINT_GROUP_EVENT.subscribe(Constants.MODID, Constants.MODID, this::groupEventListener);
        CommonEventRegistry.WAYPOINT_GROUP_TRANSFER_EVENT.subscribe(Constants.MODID, Constants.MODID, this::waypointDragHandler);
