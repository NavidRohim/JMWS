...
public class PlayerNetworkingHelper {
    public static void sendUserMessage(UUID player, String messageKey, Boolean overlay, boolean isError, boolean silent) {
    ...
    public static void sendHandshakeAndValidate(UUID joinedUser)
    {
        JMWSServerIO.validateUserObjects(joinedUser);
