...
public class ShareScreen<T extends ClientObjectWrapper<?>> extends NotificationAlertScreen {
    ...
    {
       JMWSClientCommon.setCurrentUIScreen(new ShareScreen<ClientWaypointWrapper>(minecraftClientInstance.screen, waypoint));
    }
}
