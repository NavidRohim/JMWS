...
public class ServerSyncInformation extends SyncInformation
{
    ...
    public static ServerSyncInformation getFromString(String data)
    {
    ...
    private static final class ServerSyncInfoSerializer implements JsonDeserializer<ServerSyncInformation>, JsonSerializer<ServerSyncInformation>
    {
