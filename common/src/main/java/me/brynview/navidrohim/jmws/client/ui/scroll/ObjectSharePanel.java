...
public final class ObjectSharePanel <T extends ClientObjectWrapper<?>> extends ObjectSelectionList<ObjectSharePanel.Entry> {
    ...
    public static class Entry extends ObjectSelectionList.Entry<Entry>
    {
        ...
        {
            guiGraphicsExtractor.text(CommonClass.minecraftClientInstance.font, this.displayName, this.getContentX() + PLAYER_HEAD_SIZE * 2, this.getContentYMiddle() - 2, -1);
        }
    }
    ...
    public static class PlayerEntry extends Entry
    {
        ...
        public void extractContent(@NonNull GuiGraphicsExtractor guiGraphicsExtractor, int i, int i1, boolean b, float v)
        {
            ...
            //guiGraphicsExtractor.horizontalLine(0, this.sharePanel.scrollBarX(), getContentY() , -8355712);
            //guiGraphicsExtractor.horizontalLine(0, this.sharePanel.scrollBarX(), getContentY() + getContentHeight() , -8355712);
        }
    }
}
