...
public class ClientSideServerConfigObject extends ServerConfigObject {
     ...
     */
    public ClientSideServerConfigObject(boolean jmwsEnabled, boolean waypointsEnabled, boolean groupsEnabled, boolean lookAltTeleportingEnabled, @Nullable Double serverVersion) {
        super(jmwsEnabled, waypointsEnabled, groupsEnabled, lookAltTeleportingEnabled);
