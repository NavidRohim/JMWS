...
public class Constants {
    ...
    public static final String VERSION = "1.2.5-1.21.11"; // This is purely for display and is not needed
    ...
    public static final String JourneyMapVersionString = "1.21.11-6.0.0-beta.61";
