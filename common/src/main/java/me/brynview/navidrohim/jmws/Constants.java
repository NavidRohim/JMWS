...
public class Constants {
    ...
    public static final String VERSION = "1.1.7-1.21.10-beta.rc"; // This is purely for display and is not needed
    ...
    public static final String JourneyMapVersionString = "1.21.10-6.0.0-beta.52";
