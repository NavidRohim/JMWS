...
public class Constants {
    ...
    public static final String VERSION = "1.2.7-1.21.1"; // This is purely for display and is not needed
    public static final double SERVER_VERSION = 1.14;
    public static final int JOURNEYMAP_LOCAL_SERVER_WAYPOINTS_BETA = 73;
    ...
    public static final String JourneyMapVersionString = "1.21.1-6.0.0-beta.73";
