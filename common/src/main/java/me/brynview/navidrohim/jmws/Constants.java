...
public class Constants {
    ...
    public static final String VERSION = "1.2.6-26.1.2"; // This is purely for display and is not needed
    ...
    public static final String JourneyMapVersionString = "26.1-6.0.0-beta.71";
