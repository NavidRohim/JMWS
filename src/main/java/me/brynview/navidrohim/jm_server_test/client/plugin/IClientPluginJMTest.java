    ...
    void WaypointCreationHandler(WaypointEvent waypointEvent) {
        ...
        switch (waypointEvent.getContext()) {
            case CREATE -> {
                ...
                WaypointData.put("data", waypoint.toString());
                WaypointData.put("name", waypoint.getName());
                WaypointData.put("player_uuid", player.getUuid().toString());
            ...
            case DELETED -> {
                WaypointIOInterface.deleteWaypoint(WaypointIOInterface.getWaypointFilename(waypointEvent, player.getUuid()));
            }
        }
